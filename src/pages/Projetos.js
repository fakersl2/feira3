...
function Projetos({ listaProjetos }) { // Define o componente Projetos
  ...
  const handleSearch = async (e) => {
    ...
    try {
      const response = await axios.get(
        `https://feira3-production.up.railway.app//projetos/nome/${searchTerm}` // Faz uma requisição para buscar projetos
      );
  ...
  useEffect(() => {
    axios
      .get("https://feira3-production.up.railway.app//turmas") // Busca as turmas
      .then((response) => {
    ...
    axios
      .get("https://feira3-production.up.railway.app//categorias") // Busca as categorias
      .then((response) => {
    ...
    const fetchProjetos = async () => {
      try {
        const response = await axios.get("https://feira3-production.up.railway.app//projetos"); // Busca todos os projetos
