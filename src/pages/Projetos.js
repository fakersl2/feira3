...
function Projetos({ listaProjetos }) { // Define o componente Projetos
  ...
  const handleSearch = async (e) => {
    ...
    try {
      const response = await axios.get(
        `https://feira3-back.vercel.app/projetos/nome/${searchTerm}` // Faz uma requisição para buscar projetos
      );
  ...
  useEffect(() => {
    axios
      .get("https://feira3-back.vercel.app/turmas") // Busca as turmas
      .then((response) => {
    ...
    axios
      .get("https://feira3-back.vercel.app/categorias") // Busca as categorias
      .then((response) => {
    ...
    const fetchProjetos = async () => {
      try {
        const response = await axios.get("https://feira3-back.vercel.app/projetos"); // Busca todos os projetos
